  ...
  <div> 
    <div class="w">
<div class="detail-fast-float">
  <div class="fast-wrap w">
    <p class="fast-top"> 
      <span class="fast-title" v-text="property.proTitle"></span>
      <span class="fast-price" v-text="property.proPrice"></span>
    </p>  
    <p class="fast-bot">
      <span class="fast-version" v-text="property.proVersion[0][0]"></span>
      <span class="fast-color" v-text="property.proColor" v-show="false"></span>
      <span class="fast-rom" v-text="property.proRom[0]"></span>
    </p>
     <a href="login.html" class="fast-btn">现在购买</a>
  </div>
</div>
        ...
        <div class="property">
          ...
          <div class="property-set clear">
            <dl class="property-set-version" v-if="property.proVersion">
              ...
              <dd><a target="_self" v-for="(val,i) in property.proVersion" v-text="val[0]" :href="val[1]" :class="cla[i]" @click="sty"></a></dd>
            </dl>
     ...
     methods:{
      ...
      sty:function(ev){
        var version = document.querySelector('.property-set-version');
        var versionItem = version.querySelectorAll('a');
        console.log(versionItem);
        for(var i=0;i<versionItem.length;i++){
          versionItem[i].className = '';
        }
        ev.target.className = "set-active";
      }
    },
    computed:{
/*      cla:function(){
  ...
  window.onscroll = function(){
    var float = document.querySelector('.detail-fast-float');
    var wrap = document.querySelector('.fast-wrap');
